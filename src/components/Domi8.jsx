...
<motion.div whileInView={{x: move ? -5:100}} transition={{delay:0.7}} className="text-[#ffff]  w-[646px] h-[216px] mt-6 font-normal text-xl">
...
<motion.div  whileInView={{x:  move ? 5 : -100}} transition={{delay:0.7}} className="w-[302px] h-[372px]  ml-72">
    <Image
    src="/ali.png"
    alt=""
    width="302"
